...
var Portal = React21.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom2.default.createPortal((0, import_jsx_runtime13.jsx)(Primitive.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
var SelectContentImpl = React38.forwardRef(
  (props, forwardedRef) => {
    ...
    useFocusGuards();
    const focusFirst2 = React38.useCallback(
      (candidates) => {
