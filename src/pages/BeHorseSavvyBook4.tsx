...
const faqs = [
  ...
  },
  {
    ...
    answer: "You will receive a BeHorseSavvy Level 4 Certificate of Completion."
  },
  {
...
export default function BeHorseSavvyBook4() {
  ...
  return (
    <div className="min-h-[100dvh] bg-gradient-to-b from-blue-950 to-blue-950 text-white font-dyslexic">
      <SEO 
        title="BeHorseSavvy Level 4 Course - £75 - Yard Work and Horse Handling with Penny Pleasant"
        description="BeHorseSavvy Level 4 course for advanced students. Learn yard work, horse handling, fire procedures, treatment holding, turnout, tack fitting, and protective equipment with Penny Pleasant, BHS Professional Accredited Coach. £75 course fee."
        keywords="behorsesavvy level 4, behorsesavvy book 4, yard work, horse handling, fire procedures, treatment holding, turnout, tack fitting, protective equipment, penny pleasant horse courses"
        canonicalUrl="/behorsesavvy/book4"
        courseData={{
          "@type": "Course",
          "name": "BeHorseSavvy Level 4",
          "description": "Advanced yard work and horse handling techniques for experienced learners.",
          "provider": {
            "@type": "Organization",
            "name": "BeHorseSavvy"
          },
          ...
          "url": "https://behorsesavvy.online/behorsesavvy/book4",
          "courseMode": "Online",
          "offers": {
            "@type": "Offer",
            "price": "75",
        ...
        breadcrumbData={{
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "position": 3,
              "name": "Level 4",
              "item": "https://behorsesavvy.online/behorsesavvy/book4"
            }
          ]
        }}
      />
      ...
      <section className="relative bg-blue-950 py-16 sm:py-24 md:py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            ...
            >
              Advanced yard work and horse handling techniques for experienced learners. Master safety procedures, treatment holding, turnout, and professional equipment care.
            </motion.p>
            <motion.div
              variants={fadeInUp}
      ...
      <section className="py-12 sm:py-16 md:py-24 bg-blue-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold mb-6 text-white">BeHorseSavvy Level 4</h2>
          </motion.div>
          <motion.div 
            variants={fadeInUp}
            initial="initial"
              ...
              <div className="relative">
                ...
                <ul className="space-y-3 text-white/90">
                  <li className="flex items-start">
                    ...
                    <span>Fire and accident procedures</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Holding horses for treatment</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Trot up for inspection</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Turn out and catch horses</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Tack fitting and checking</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Protective equipment use</span>
                  </li>
                </ul>
              </div>
            </motion.div>
              ...
              <div className="relative">
                ...
                <ul className="space-y-3 text-white/90">
                  <li className="flex items-start">
                    ...
                    <span>Professional yard skills</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Safety and emergency procedures</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Advanced horse handling</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Equipment expertise</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
            ...
            >
              ...
              <div className="relative">
                ...
                <ul className="space-y-3 text-white/90">
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Level 3 graduates</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Yard workers</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                  ...
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Advanced horse handlers</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Those seeking yard skills</span>
                  </li>
                </ul>
              </div>
            </motion.div>
        ...
        <div className="backdrop-blur-sm bg-white/10 border border-white/20 hover:border-white/40 transition-all duration-300 rounded-xl shadow-xl p-8 sm:p-10 relative overflow-hidden group">
          ...
          <div className="relative z-10">
            <ul className="space-y-4 text-white/90">
              ...
              <li className="flex items-start">
                <span className="text-red-400 mr-3 mt-1">•</span>
                <span>Professional horse handling techniques</span>
              </li>
              <li className="flex items-start">
                <span className="text-red-400 mr-3 mt-1">•</span>
                <span>Treatment and inspection procedures</span>
              </li>
              <li className="flex items-start">
                <span className="text-red-400 mr-3 mt-1">•</span>
                <span>Field management skills</span>
              </li>
              <li className="flex items-start">
                <span className="text-red-400 mr-3 mt-1">•</span>
                <span>Tack fitting expertise</span>
              </li>
              <li className="flex items-start">
                <span className="text-red-400 mr-3 mt-1">•</span>
                <span>Protective equipment knowledge</span>
              </li>
              <li className="flex items-start">
                <span className="text-red-400 mr-3 mt-1">•</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-red-600/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="relative">
                <h3 className="text-2xl font-bold mb-6 text-white">Module 1: Safety & Procedures</h3>
                <ul className="space-y-3 text-white/90">
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Fire and Accident Procedures</span>
                  ...
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Emergency protocols and safety measures</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Yard safety standards</span>
                  </li>
                </ul>
              </div>
            </motion.div>
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-red-600/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="relative">
                <h3 className="text-2xl font-bold mb-6 text-white">Module 2: Horse Handling</h3>
                <ul className="space-y-3 text-white/90">
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Holding Horses for Treatment</span>
                  ...
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Professional handling techniques</span>
                  </li>
                </ul>
              </div>
            </motion.div>
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-red-600/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="relative">
                <h3 className="text-2xl font-bold mb-6 text-white">Module 3: Field Management</h3>
                <ul className="space-y-3 text-white/90">
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Turn Out and Catch Horses</span>
                  ...
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Field safety and management</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Group dynamics and handling</span>
                  </li>
                </ul>
              </div>
            </motion.div>
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-red-600/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="relative">
                <h3 className="text-2xl font-bold mb-6 text-white">Module 4: Equipment & Tack</h3>
                <ul className="space-y-3 text-white/90">
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Check Tack Fits Comfortably</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Brushing Boots and Overreach Boots</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-white/80 max-w-2xl mx-auto mb-8">
              Master yard work and horse handling with BeHorseSavvy Level 4
            </p>
          </motion.div>
            ...
            >
              ...
              <div className="relative">
                <div className="text-center">
                  ...
                  <h4 className="font-serif text-xl font-bold text-white mb-5">Level 4</h4>
                  ...
                  <div className="bg-white/5 rounded-lg p-4 mb-8">
                    <ul className="space-y-3 text-left">
                      <li className="flex items-center text-white/90">
                        ...
                        <span>Advanced yard work skills</span>
                      </li>
                  ...
                  <Button
                    onClick={() => {
                      window.location.href = "mailto:Penelopepleasant@gmail.com?subject=BeHorseSavvy%20Level%204%20Enquiry";
                    }}
