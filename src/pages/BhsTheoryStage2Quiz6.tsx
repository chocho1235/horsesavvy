...
const questions: Question[] = [
  {
    id: 1,
    question: "Which of the following combinations is the MOST effective set of stable yard practices to reduce injury risk during winter weather?",
    options: [
      "Use straw bedding, leave lights off to save power, allow dogs to roam free",
      "Salt icy areas, secure all loose objects, use non-slip matting in walkways",
      "Keep all doors closed at all times, avoid cleaning drains in cold weather",
      "Move horses out only during sunny afternoons, don't allow machinery near barns"
    ],
    correctAnswer: 1,
    explanation: "B addresses real risks like slipping and wind hazards with practical, preventive solutions."
  }
];

export default function BhsTheoryStage2Quiz6() {
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl font-semibold mb-6 text-white">
              BHS Theory Stage 2 - Quiz 6
            </h2>
            <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
              Test your knowledge of winter yard safety practices.
            </p>
          ...
          {!quizCompleted ? (
            ...
            >
              ...
              <p className="text-gray-600 text-lg mb-8 max-w-2xl mx-auto">
                Congratulations! You've completed all {questions.length} questions in the BeHorseSavvy BHS Theory Stage 2 Quiz 6. You can now return to the course.
              </p>
