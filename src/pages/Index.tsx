...
const Index = () => {
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden relative animation-container">
      {/* Background pattern */}
          ...
          <div className="md:pl-[400px]">
            <div className="max-w-[1000px] flex flex-col gap-8 items-center">
              ...
              <motion.div 
                ...
                className="flex-1 w-full animate-gpu"
                data-animate="true"
              >
