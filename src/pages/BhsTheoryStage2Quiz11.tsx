...
const questions: Question[] = [
  {
    id: 1,
    question: "Why should all tack be checked before riding?",
    type: 'multiple-choice',
    options: [
      "To make sure it looks clean",
      "To ensure it is not damaged, which could lead to accidents during the ride",
      "To check if it matches the horse's colour",
      "To see if it's expensive"
    ],
    correctAnswer: 1,
    explanation: "To ensure it is not damaged, which could lead to accidents during the ride."
  },
  {
    id: 2,
    question: "What is the correct knot to use when tying a horse and why?",
    type: 'multiple-choice',
    options: [
      "A double knot, to keep the horse secure",
      "A quick-release knot, so the horse can be freed quickly in an emergency",
      "Any knot that looks strong",
      "A slip knot, because it's easy to tie"
    ],
    correctAnswer: 1,
    explanation: "A quick-release knot, so the horse can be freed quickly in an emergency."
  },
  {
    id: 3,
    question: "What personal protective equipment (PPE) should a groom wear daily?",
    type: 'multiple-choice',
    options: [
      "Just comfortable clothes",
      "Sturdy boots, gloves, and sometimes a helmet or high-visibility clothing",
      "Only a hat and sunglasses",
      "Whatever they feel like wearing"
    ],
    correctAnswer: 1,
    explanation: "Sturdy boots, gloves, and sometimes a helmet or high-visibility clothing."
  },
  {
    id: 4,
    question: "Why is it important to disinfect grooming tools regularly?",
    type: 'multiple-choice',
    options: [
      "To make them look shiny",
      "To stop the spread of skin infections or diseases between horses",
      "To save money on new tools",
      "Because it's a tradition"
    ],
    correctAnswer: 1,
    explanation: "To stop the spread of skin infections or diseases between horses."
  }
];

export default function BhsTheoryStage2Quiz11() {
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl font-semibold mb-6 text-white">
              BHS Theory Stage 2 - Quiz 11
            </h2>
            <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
              Test your knowledge of Health & Safety in the equine industry.
            </p>
          ...
          {!quizCompleted ? (
            ...
            >
              ...
              <p className="text-gray-600 text-lg mb-8 max-w-2xl mx-auto">
                Congratulations! You've completed all {questions.length} questions in the BeHorseSavvy BHS Theory Stage 2 Quiz 11. You can now return to the course.
              </p>
