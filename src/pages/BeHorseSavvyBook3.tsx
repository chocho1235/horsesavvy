...
const faqs = [
  ...
  },
  {
    ...
    answer: "You will receive a BeHorseSavvy Level 3 Certificate of Completion."
  },
  {
...
export default function BeHorseSavvyBook3() {
  ...
  return (
    <div className="min-h-[100dvh] bg-gradient-to-b from-blue-950 to-blue-950 text-white font-dyslexic">
      <SEO 
        title="BeHorseSavvy Level 3 Course - £75 - Advanced Horse Care with Penny Pleasant"
        description="BeHorseSavvy Level 3 course for advanced students. Learn horse communication, stable management, poisonous plants, field care, rug fitting, and advanced grooming with Penny Pleasant, BHS Professional Accredited Coach. £75 course fee."
        keywords="behorsesavvy level 3, behorsesavvy book 3, advanced horse care, horse communication, stable management, poisonous plants, field care, rug fitting, advanced grooming, penny pleasant horse courses"
        canonicalUrl="/behorsesavvy/book3"
        courseData={{
          "@type": "Course",
          "name": "BeHorseSavvy Level 3",
          "description": "Advanced horse care and communication techniques for experienced learners.",
          "provider": {
            "@type": "Organization",
            "name": "BeHorseSavvy"
          },
          ...
          "audience": "Experienced learners",
          "url": "https://behorsesavvy.online/behorsesavvy/book3",
          "courseMode": "Online",
          "offers": {
            "@type": "Offer",
            "price": "75",
        ...
        breadcrumbData={{
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "position": 3,
              "name": "Level 3",
              "item": "https://behorsesavvy.online/behorsesavvy/book3"
            }
          ]
        }}
      />
      ...
      <section className="relative bg-blue-950 py-16 sm:py-24 md:py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            ...
            >
              Advanced horse care and communication techniques for experienced learners. Master communication, stable management, safety, and professional grooming.
            </motion.p>
            <motion.div
              variants={fadeInUp}
      ...
      <section className="py-12 sm:py-16 md:py-24 bg-blue-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold mb-6 text-white">BeHorseSavvy Level 3</h2>
          </motion.div>
          <motion.div 
            variants={fadeInUp}
            initial="initial"
              ...
              <div className="relative">
                ...
                <ul className="space-y-3 text-white/90">
                  <li className="flex items-start">
                    ...
                    <span>How horses communicate</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Stable management techniques</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Poisonous plants identification</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Field care and management</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Rug fitting and checking</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Advanced grooming techniques</span>
                  </li>
                </ul>
              </div>
            </motion.div>
              ...
              <div className="relative">
                ...
                <ul className="space-y-3 text-white/90">
                  <li className="flex items-start">
                    ...
                    <span>Advanced horse care skills</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Professional communication techniques</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Safety and welfare knowledge</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Practical management skills</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Professional grooming standards</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
            ...
            >
              ...
              <div className="relative">
                ...
                <ul className="space-y-3 text-white/90">
                  ...
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Experienced horse enthusiasts</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Those seeking advanced skills</span>
                  </li>
                </ul>
              </div>
            </motion.div>
          ...
          <div className="relative z-10">
            <ul className="space-y-4 text-white/90">
              <li className="flex items-start">
                ...
                <span>Advanced horse communication techniques</span>
              </li>
              <li className="flex items-start">
                <span className="text-red-400 mr-3 mt-1">•</span>
                <span>Professional stable management skills</span>
              </li>
              <li className="flex items-start">
                <span className="text-red-400 mr-3 mt-1">•</span>
                <span>Comprehensive safety knowledge</span>
              </li>
              <li className="flex items-start">
                <span className="text-red-400 mr-3 mt-1">•</span>
                <span>Field care expertise</span>
              </li>
              <li className="flex items-start">
                <span className="text-red-400 mr-3 mt-1">•</span>
                <span>Advanced rug fitting techniques</span>
              </li>
              <li className="flex items-start">
                <span className="text-red-400 mr-3 mt-1">•</span>
                <span>Professional grooming standards</span>
      ...
      {/* Course Content */}
      <section className="py-12 sm:py-16 md:py-24 bg-blue-950/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            variants={fadeInUp}
            initial="initial"
            ...
            className="text-center mb-12"
          >
            <h2 className="text-3xl sm:text-4xl font-bold mb-6 text-white">Course Content</h2>
            <div className="w-16 h-1 mx-auto bg-red-600/70 mb-8"></div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <motion.div
              ...
              whileInView="whileInView"
              viewport={{ once: true, margin: "-50px" }}
              className="backdrop-blur-sm bg-white/10 border border-white/20 hover:border-white/40 transition-all duration-300 rounded-xl shadow-xl p-8 relative overflow-hidden group"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-red-600/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="relative">
                <h3 className="text-2xl font-bold mb-6 text-white">Module 1: Communication & Safety</h3>
                <ul className="space-y-3 text-white/90">
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>How Horses Communicate</span>
                  ...
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Which Plants and Trees are Poisonous to Horses</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-red-600/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="relative">
                <h3 className="text-2xl font-bold mb-6 text-white">Module 2: Management & Care</h3>
                <ul className="space-y-3 text-white/90">
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>How to Muck Out a Stable</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>How to Care for Your Horse in the Field</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Advanced stable management</span>
                  </li>
                </ul>
              </div>
            </motion.div>
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-red-600/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="relative">
                <h3 className="text-2xl font-bold mb-6 text-white">Module 3: Equipment & Grooming</h3>
                <ul className="space-y-3 text-white/90">
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>How to Check the Fit of a Rug</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Further Grooming Techniques</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Professional equipment care</span>
                  </li>
                </ul>
              </div>
            </motion.div>
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-red-600/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="relative">
                <h3 className="text-2xl font-bold mb-6 text-white">Additional Resources</h3>
                <ul className="space-y-3 text-white/90">
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
                    <span>Interactive worksheets and activities</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="w-5 h-5 text-red-400 mr-2 mt-0.5 flex-shrink-0" />
      ...
      <section className="py-12 sm:py-16 md:py-24 bg-blue-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            ...
            className="text-center mb-12"
          >
            <h2 className="text-3xl sm:text-4xl font-bold mb-6 text-white">Course Snapshot</h2>
            <div className="w-16 h-1 mx-auto bg-red-600/70 mb-8"></div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            <motion.div
              ...
              whileInView="whileInView"
              viewport={{ once: true, margin: "-50px" }}
              className="text-center backdrop-blur-sm bg-white/10 p-8 rounded-xl border border-white/20 hover:border-white/40 transition-all duration-300 shadow-xl"
            >
              <Clock className="w-12 h-12 text-red-400 mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-4 text-white">Duration</h3>
              <p className="text-white/80">Self-paced learning</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-4 text-white">Format</h3>
              <p className="text-white/80">Digital course materials</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-4 text-white">Study Anywhere</h3>
              <p className="text-white/80">Learn at your own pace</p>
            </motion.div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-white/80 max-w-2xl mx-auto mb-8">
              Master advanced horse care with BeHorseSavvy Level 3
            </p>
          </motion.div>
            ...
            >
              ...
              <div className="relative">
                <div className="text-center">
                  ...
                  <h4 className="font-serif text-xl font-bold text-white mb-5">Level 3</h4>
                  ...
                  <div className="bg-white/5 rounded-lg p-4 mb-8">
                    <ul className="space-y-3 text-left">
                      <li className="flex items-center text-white/90">
                        ...
                        <span>Advanced horse care techniques</span>
                      </li>
                  ...
                  <Button
                    onClick={() => {
                      window.location.href = "mailto:Penelopepleasant@gmail.com?subject=BeHorseSavvy%20Level%203%20Enquiry";
                    }}
