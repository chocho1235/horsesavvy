    ...
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
      ...
      <section className="relative pt-32 pb-16">
        <div className="max-w-5xl mx-auto px-6">
          ...
          >
            <div className="w-[280px] h-[280px] rounded-full bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm animate-pulse" />
          </motion.div>
          ...
          >
            <div className="w-[200px] h-[200px] rounded-full bg-gradient-to-tr from-white/10 to-white/5 backdrop-blur-sm animate-pulse" style={{ animationDuration: '8s' }} />
          </motion.div>
            ...
            >
              <div className="relative overflow-hidden rounded-xl shadow-xl border border-white/10">
                <img 
                  src="/DSC_1374.jpg" 
                  alt="BeHorseSavvy" 
                  className="w-full h-auto object-cover transform-gpu hover:scale-105 transition-transform duration-700" 
                />
          ...
          >
            <div className="bg-white/5 rounded-xl p-6 backdrop-blur-sm border border-white/10 transition-all duration-300 hover:bg-white/10">
