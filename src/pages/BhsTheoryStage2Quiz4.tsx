...
const questions: Question[] = [
  {
    id: 1,
    question: "Why is it important to report a horse showing signs of distress?",
    options: [
      "So you can swap horses",
      "To ensure the horse's health and safety is checked",
      "To avoid riding that day",
      "So others can pet the horse"
    ],
    correctAnswer: 1,
    explanation: "To ensure the horse's health and safety is checked."
  },
  {
    id: 2,
    question: "What is the most appropriate action if you are unsure about how to tack up a horse?",
    options: [
      "Try your best and hope it's right",
      "Ask a friend instead",
      "Report to the responsible person or instructor",
      "Avoid tacking up altogether"
    ],
    correctAnswer: 2,
    explanation: "Report to the responsible person or instructor."
  },
  {
    id: 3,
    question: "When should you report an incident to a responsible person?",
    options: [
      "Only if someone gets seriously injured",
      "Only if you're asked to",
      "Whenever something unusual or unsafe happens",
      "Never—it's not your job"
    ],
    correctAnswer: 2,
    explanation: "Whenever something unusual or unsafe happens."
  },
  {
    id: 4,
    question: "Who is usually considered the 'responsible person' at a riding school?",
    options: [
      "The horse",
      "Any older rider",
      "The designated instructor or yard manager",
      "The person who owns the tack"
    ],
    correctAnswer: 2,
    explanation: "The designated instructor or yard manager."
  },
  {
    id: 5,
    question: "Reporting to a responsible person helps with all the following EXCEPT:",
    options: [
      "Maintaining discipline and safety",
      "Ensuring proper care of the horses",
      "Avoiding having to do your chores",
      "Helping instructors support students"
    ],
    correctAnswer: 2,
    explanation: "Avoiding having to do your chores."
  }
];

export default function BhsTheoryStage2Quiz4() {
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl font-semibold mb-6 text-white">
              BHS Theory Stage 2 - Quiz 4
            </h2>
            <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
              Test your knowledge of reporting procedures and responsible persons.
            </p>
          ...
          {!quizCompleted ? (
            ...
            >
              ...
              <p className="text-gray-600 text-lg mb-8 max-w-2xl mx-auto">
                Congratulations! You've completed all {questions.length} questions in the BeHorseSavvy BHS Theory Stage 2 Quiz 4. You can now return to the course.
              </p>
