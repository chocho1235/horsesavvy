...
const questions: Question[] = [
  {
    id: 1,
    question: "What is the best way to store horse feed?",
    options: [
      "In open bags near the stall",
      "In airtight, rodent-proof bins",
      "On the floor of the barn",
      "Mixed with other supplies"
    ],
    correctAnswer: 1,
    explanation: "In airtight, rodent-proof bins."
  },
  {
    id: 2,
    question: "What item is typically stored in the tack room?",
    options: [
      "Hay bales",
      "Wheelbarrows",
      "Saddles",
  ...
  {
    id: 3,
    question: "Why is proper tool storage important in a barn?",
    options: [
      "To keep the barn warm",
      "To prevent injury and damage",
      "To feed the horses",
      "To reduce riding time"
    ],
    correctAnswer: 1,
    explanation: "To prevent injury and damage."
  },
  {
    id: 4,
    question: "What is a horse blanket used for?",
    options: [
      "Grooming",
      "Riding",
    ...
    correctAnswer: 2,
    explanation: "Keeping the horse warm."
  },
  {
    id: 5,
    question: "What should a first aid station include?",
    options: [
      "Treats and grooming brushes",
      "Helmets and boots",
      "Bandages and antiseptics",
      "Feed buckets"
    ],
    correctAnswer: 2,
    explanation: "Bandages and antiseptics."
  },
  {
    id: 6,
    ...
    correctAnswer: 2,
    explanation: "Maintaining arenas."
  },
  {
    id: 7,
    question: "Where should digital training records ideally be stored?",
    options: [
      "On stall doors",
      "In the hayloft",
      "In the tack box",
      "In the office or cloud storage"
    ],
    correctAnswer: 3,
    explanation: "In the office or cloud storage."
  },
  {
    id: 8,
    question: "What is the purpose of the barn layout being open and ventilated?",
    options: [
      "Better visibility for photos",
      "Faster riding",
      "Horse health and airflow",
      "Easier painting"
    ],
    correctAnswer: 2,
    explanation: "Horse health and airflow."
  },
  {
    id: 9,
    question: "Which of these should be hung on a saddle rack?",
    options: [
      "Girth",
      "Bridle",
      "Saddle",
  ...
  {
    id: 10,
    question: "Why is organizing equipment and data so important?",
    options: [
      "Makes the barn look expensive",
      "Reduces the need for staff",
      "Improves safety and care",
      "Allows for shorter riding times"
    ],
    correctAnswer: 2,
    explanation: "Improves safety and care."
  }
];

export default function BhsTheoryStage2Quiz8() {
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl font-semibold mb-6 text-white">
              BHS Theory Stage 2 - Quiz 8
            </h2>
            <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
              Test your knowledge of barn organization and equipment storage.
            </p>
          ...
          {!quizCompleted ? (
            ...
            >
              ...
              <p className="text-gray-600 text-lg mb-8 max-w-2xl mx-auto">
                Congratulations! You've completed all {questions.length} questions in the BeHorseSavvy BHS Theory Stage 2 Quiz 8. You can now return to the course.
              </p>
